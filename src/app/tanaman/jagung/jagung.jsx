...
export default function JagungPage() {
  return (
    <div className="min-h-screen bg-[#f1f4e8] px-6">
      ...
      <div className="flex flex-col items-center mt-10">
        <Image src="/images/jagung.jpg" alt="Jagung" width={400} height={250} className="rounded-xl" />

        <h2 className="text-center text-xl italic mt-4">Jagung</h2>

        <div className="bg-white rounded-2xl mt-4 px-6 py-4 max-w-2xl text-sm text-justify shadow">
          Jagung membutuhkan banyak sinar matahari dan ruang tanam yang cukup. Cocok ditanam di kebun terbuka dan menghasilkan tongkol kaya karbohidrat.
        </div>
